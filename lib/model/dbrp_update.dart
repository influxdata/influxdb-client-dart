...
class DBRPUpdate {
  ...
  @override
  String toString() =>
      'DBRPUpdate[retentionPolicy=$retentionPolicy, default_=$default_]';
  ...
  static List<DBRPUpdate>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, DBRPUpdate?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = DBRPUpdate.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of DBRPUpdate-objects as value to a dart map
  static Map<String, List<DBRPUpdate?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
