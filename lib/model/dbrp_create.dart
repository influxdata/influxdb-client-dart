...
class DBRPCreate {
  ...
  @override
  String toString() =>
      'DBRPCreate[orgID=$orgID, org=$org, bucketID=$bucketID, database=$database, retentionPolicy=$retentionPolicy, default_=$default_]';
  ...
  static List<DBRPCreate>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, DBRPCreate?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = DBRPCreate.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of DBRPCreate-objects as value to a dart map
  static Map<String, List<DBRPCreate?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
