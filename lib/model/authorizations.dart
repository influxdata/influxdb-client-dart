...
class Authorizations {
  ...
  @override
  String toString() =>
      'Authorizations[links=$links, authorizations=$authorizations]';
  ...
  static List<Authorizations?>? listFromJson(
    List<dynamic> json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json.isEmpty
          ? true == emptyIsNull
              ...
              : <Authorizations>[]
          : json
              .map((dynamic value) => Authorizations.fromJson(value))
