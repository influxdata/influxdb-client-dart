...
class ResourceOwners {
  ...
  bool operator ==(Object other) =>
      ...
      other is ResourceOwners && other.links == links && other.users == users;
  ...
  static List<ResourceOwners>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, ResourceOwners?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = ResourceOwners.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ResourceOwners-objects as value to a dart map
  static Map<String, List<ResourceOwners?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
