...
class SecretKeysResponseAllOfLinks {
  ...
  bool operator ==(Object other) =>
      ...
      other is SecretKeysResponseAllOfLinks &&
          other.self == self &&
          other.org == org;
  ...
  int get hashCode =>
      ...
      (self == null ? 0 : self.hashCode) + (org == null ? 0 : org.hashCode);
  ...
  static List<SecretKeysResponseAllOfLinks>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(SecretKeysResponseAllOfLinks.fromJson)
  ...
  static Map<String, SecretKeysResponseAllOfLinks?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach((key, dynamic value) =>
          map[key] = SecretKeysResponseAllOfLinks.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SecretKeysResponseAllOfLinks-objects as value to a dart map
  static Map<String, List<SecretKeysResponseAllOfLinks?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
