...
class AddResourceMemberRequestBody {
  ...
  bool operator ==(Object other) =>
      ...
      other is AddResourceMemberRequestBody &&
          other.id == id &&
          other.name == name;
  ...
  static List<AddResourceMemberRequestBody>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(AddResourceMemberRequestBody.fromJson)
  ...
  static Map<String, AddResourceMemberRequestBody?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach((key, dynamic value) =>
          map[key] = AddResourceMemberRequestBody.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AddResourceMemberRequestBody-objects as value to a dart map
  static Map<String, List<AddResourceMemberRequestBody?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
