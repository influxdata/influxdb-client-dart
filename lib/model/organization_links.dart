...
class OrganizationLinks {
  ...
  @override
  String toString() =>
      'OrganizationLinks[self=$self, members=$members, owners=$owners, labels=$labels, secrets=$secrets, buckets=$buckets, tasks=$tasks, dashboards=$dashboards]';
  ...
  static List<OrganizationLinks>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(OrganizationLinks.fromJson)
  ...
  static Map<String, OrganizationLinks?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = OrganizationLinks.fromJson(value));
    }
    return map;
  }
