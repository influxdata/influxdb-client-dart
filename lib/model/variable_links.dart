...
class VariableLinks {
  ...
  static List<VariableLinks>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
  ...
  static Map<String, VariableLinks?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = VariableLinks.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of VariableLinks-objects as value to a dart map
  static Map<String, List<VariableLinks?>?> mapListFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) {
