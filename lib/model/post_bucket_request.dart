...
class PostBucketRequest {
  ...
  @override
  String toString() =>
      'PostBucketRequest[orgID=$orgID, name=$name, description=$description, rp=$rp, retentionRules=$retentionRules, schemaType=$schemaType]';
  ...
  static List<PostBucketRequest>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(PostBucketRequest.fromJson)
  ...
  static Map<String, PostBucketRequest?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = PostBucketRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PostBucketRequest-objects as value to a dart map
  static Map<String, List<PostBucketRequest?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
