...
class PostOrganizationRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostOrganizationRequest &&
          other.name == name &&
  ...
  @override
  String toString() =>
      'PostOrganizationRequest[name=$name, description=$description]';
  ...
  static List<PostOrganizationRequest>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(PostOrganizationRequest.fromJson)
  ...
  static Map<String, PostOrganizationRequest?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach((key, dynamic value) =>
          map[key] = PostOrganizationRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PostOrganizationRequest-objects as value to a dart map
  static Map<String, List<PostOrganizationRequest?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
