...
class Organizations {
  ...
  bool operator ==(Object other) =>
      ...
      other is Organizations && other.links == links && other.orgs == orgs;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (links == null ? 0 : links.hashCode) + (orgs == null ? 0 : orgs.hashCode);
  ...
  static Map<String, Organizations?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = Organizations.fromJson(value));
    }
    return map;
  }
