...
class TaskLinks {
  ...
  @override
  String toString() =>
      'TaskLinks[self=$self, owners=$owners, members=$members, runs=$runs, logs=$logs, labels=$labels]';
  ...
  static List<TaskLinks>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, TaskLinks?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = TaskLinks.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of TaskLinks-objects as value to a dart map
  static Map<String, List<TaskLinks?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
