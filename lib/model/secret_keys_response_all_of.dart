...
class SecretKeysResponseAllOf {
  ...
  bool operator ==(Object other) =>
      ...
      other is SecretKeysResponseAllOf && other.links == links;
  ...
  static List<SecretKeysResponseAllOf>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(SecretKeysResponseAllOf.fromJson)
  ...
  static Map<String, SecretKeysResponseAllOf?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach((key, dynamic value) =>
          map[key] = SecretKeysResponseAllOf.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SecretKeysResponseAllOf-objects as value to a dart map
  static Map<String, List<SecretKeysResponseAllOf?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
