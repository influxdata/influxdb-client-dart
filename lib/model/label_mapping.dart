...
class LabelMapping {
  ...
  bool operator ==(Object other) =>
      ...
      other is LabelMapping && other.labelID == labelID;
  ...
  static List<LabelMapping>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, LabelMapping?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = LabelMapping.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of LabelMapping-objects as value to a dart map
  static Map<String, List<LabelMapping?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
