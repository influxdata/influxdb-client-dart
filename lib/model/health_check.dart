...
class HealthCheck {
  ...
  @override
  String toString() =>
      'HealthCheck[name=$name, message=$message, checks=$checks, status=$status, version=$version, commit=$commit]';
  ...
  static List<HealthCheck>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, HealthCheck?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = HealthCheck.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of HealthCheck-objects as value to a dart map
  static Map<String, List<HealthCheck?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
...
class HealthCheckStatusEnum {
  ...
  static List<HealthCheckStatusEnum?>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(HealthCheckStatusEnum.fromJson)
...
class HealthCheckStatusEnumTypeTransformer {
  factory HealthCheckStatusEnumTypeTransformer() =>
      _instance ??= const HealthCheckStatusEnumTypeTransformer._();
  ...
  HealthCheckStatusEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
      switch (data.toString()) {
        ...
        default:
          return HealthCheckStatusEnum._(data.toString());
      }
    }
    return null;
  }
