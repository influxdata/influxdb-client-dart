...
class UserResponseStatusEnum {
  ...
  static List<UserResponseStatusEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UserResponseStatusEnum.fromJson).toList(growable: true == growable)
...
class UserResponseStatusEnumTypeTransformer {
  factory UserResponseStatusEnumTypeTransformer() => _instance ??= const UserResponseStatusEnumTypeTransformer._();
  ...
  UserResponseStatusEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
      switch (data.toString()) {
        ...
        default: return UserResponseStatusEnum._(data.toString());
      }
    }
    return null;
  }
