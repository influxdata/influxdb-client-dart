...
class PatchBucketRequest {
  ...
  static List<PatchBucketRequest>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PatchBucketRequest.fromJson).toList(growable: true == growable)
  ...
  static Map<String, PatchBucketRequest?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PatchBucketRequest.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PatchBucketRequest-objects as value to a dart map
  static Map<String, List<PatchBucketRequest?>?> mapListFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) {
