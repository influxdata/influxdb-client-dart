...
class AuthorizationAllOfLinks {
  ...
  static List<AuthorizationAllOfLinks>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(AuthorizationAllOfLinks.fromJson).toList(growable: true == growable)
  ...
  static Map<String, AuthorizationAllOfLinks?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = AuthorizationAllOfLinks.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of AuthorizationAllOfLinks-objects as value to a dart map
  static Map<String, List<AuthorizationAllOfLinks?>?> mapListFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) {
