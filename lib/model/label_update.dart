...
class LabelUpdate {
  ...
  static List<LabelUpdate>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, LabelUpdate?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = LabelUpdate.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of LabelUpdate-objects as value to a dart map
  static Map<String, List<LabelUpdate?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
