...
class SecretKeys {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SecretKeys && other.secrets == secrets;
  ...
  static List<SecretKeys>? listFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) =>
  ...
  static Map<String, SecretKeys?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = SecretKeys.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SecretKeys-objects as value to a dart map
  static Map<String, List<SecretKeys?>?> mapListFromJson(
    dynamic json, {
    bool? emptyIsNull,
    bool? growable,
  }) {
